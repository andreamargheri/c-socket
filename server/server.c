			...
			while(tmp != NULL){
				...
				if (list->file_name == NULL){
					...
					if (flag == 0){
						...
						*
						*
						* CAMBIARE LE QUATTRO ISTRUZIONI SEGUENTI SE SI VUOL FARE LISTA IN ORDINE ALFABETICO. 
						* ATTENZIONE AD AGGIORNARE BENE GLI INDICI QUANDO SI INSERISCE UN ELEMENTO IN MEZZO ALLA LISTA
						*
						*
						*/
						//file name not found
